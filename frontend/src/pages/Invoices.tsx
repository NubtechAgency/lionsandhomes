...
export default function Invoices() {
  ...
  const isScanner = location.pathname === '/invoices/scanner';
      ...
      <div className="p-6 lg:p-8 max-w-7xl mx-auto">
        ...
        {isScanner ? (
          <>
            ...
            {/* Orphans / Acciones pendientes */}
            <h2 className="text-lg font-semibold text-gray-900 mb-4">
              Acciones pendientes
              {orphanTotal > 0 && (
                <span className="ml-2 text-sm font-normal text-gray-500">{orphanTotal}</span>
              )}
            </h2>
            ...
            {orphanLoading ? (
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
                ...
                <h3 className="text-lg font-medium text-gray-600">Sin facturas pendientes</h3>
                <p className="text-gray-400 mt-2">Sube facturas arriba para empezar a vincularlas</p>
              </div>
            ) : (
          ...
          /* Invoice list view (Facturas de compra) */
          <>
            {/* Summary */}
